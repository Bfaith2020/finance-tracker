							...
							<div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
								<div>
									...
									<p className="text-green-700 text-base">
										Here’s your personal finance overview. Stay on track
										...
										<div className="overflow-hidden mt-6">
											<div
												style={{
													...
													animation:
														"slideInTip 2.5s cubic-bezier(.4,0,.2,1)",
									...
									<div className="mt-4 flex gap-3 flex-wrap">
										{BADGES.map((badge, idx) => (
											<div
												key={idx}
												className="flex items-center gap-1 px-3 py-1 rounded-full bg-green-200 text-green-900 text-sm font-semibold shadow"
											>
