...
const DashboardLayout = ({ children, activeMenu, spendingAlerts = [] }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-100 transition-colors">
